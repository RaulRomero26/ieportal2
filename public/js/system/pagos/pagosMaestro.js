...
const editPago = (obj) => {
    ...
    //document.getElementById('monto_pagom').readOnly = true;

    //document.getElementById('button_query2').name = "Guardar";
...
const updateRowPago = (data) => {
    ...
    document.getElementById('monto_pagom').readOnly = false;
...
async function crear_guardarPM(e) {
    ...
    urlFetch += "/editPagosFetch";//editar
    //console.log(urlFetch)
    var formInsp = document.getElementById("pagos_maestro");
...
const readTablePagos = () => {
    const table = document.getElementById('table_pagos_maestro');
    let lista_pagos = [];
