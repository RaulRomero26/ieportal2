...
<div class="container mt-5 mb-3">
    <div class="row">
        <div class="col-auto mr-auto my-auto">
            <h5 class="title-width my-auto">Creador de Clases</h5>
        </div>
        <div class="col-auto my-auto ">
            <a class="btn btn-opacity <?= ($_SESSION['userdata']->Clases[3])?'':'mi_hide';?>" href="<?= base_url;?>Clases/nuevo" >Nueva Clase</a>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto  d-flex justify-content-center">
            ...
            <div class="dropdown-menu" aria-labelledby="id_filtros">
                ...
                <a class="dropdown-item <?= ($data['filtroActual']==1)?'active':'';?>" href="<?= base_url;?>Clases/index/?filtro=1">Todas las clases</a>
                <a class="dropdown-item <?= ($data['filtroActual']==2)?'active':'';?>" href="<?= base_url;?>Clases/index/?filtro=2">Por Alumnos</a>
            </div>
        </div>
        <div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto  d-flex justify-content-center">
            <!-- Button trigger modal -->
        ...
        <div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto d-flex justify-content-center">
            <div class="row">
                <div id="buttonsExport" class="col-12">
                    ...
                    ?>
                    <a id="id_link_pdf" href="<?= base_url ?>Clases/generarFicha/?tipo_export=<?= "PDF".$cadenaExport.$filtroActual; ?>" target="_blank" class="btn" data-toggle="tooltip" data-placement="bottom" title="Exportar a PDF">
                        <i class="material-icons ssc md-36">picture_as_pdf</i>
                        <!--img src="<?= base_url ?>public/media/icons/pdfIcon.png" width="40px"--!-->
                    </a>
                    <a id="id_link_excel" href="<?= base_url ?>Clases/exportarInfo/?tipo_export=<?= "EXCEL".$cadenaExport.$filtroActual; ?>" class="btn" data-toggle="tooltip" data-placement="bottom" title="Exportar a Excel">
    ...
    <div class="row d-flex justify-content-center mt-3">
        ...
        <?php
            if (isset($_SESSION['userdata']->rango_inicio_rem)) {
                ?>
                    <a class="btn btn-opacity" href="<?= base_url;?>Clases/removeRangosFechasSesion/?filtroActual=<?= $data['filtroActual'];?>">mostrar todo</a>
                <?php
            }
        ?>
    </div>  
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form id="form_rangos" class="row filter-content mb-3" method="post" action="<?= base_url;?>Clases/index/?filtro=<?= $data['filtroActual']?>">
                        <div class="col-3">
