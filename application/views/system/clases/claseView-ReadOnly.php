<div class="container-fluid">    
   ...
   ?>
    ...
    <div class="row col-12 text-center my- mt-5">
		<h5>Creación de una clase</h5>
	</div>  


            <div class="form-group col-lg-6">
                <label for="estatus_clase" class="label-form">Estatus de la clase:</label>
                <select class="custom-select custom-select-sm" id="estatus_clase" name="estatus_clase" readonly>
            ...
            <div class="form-row mt-5">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select class="custom-select custom-select-sm" id="profesor_asignado" name="profesor_asignado" readonly>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select class="custom-select custom-select-sm" id="nivel_clase" name="nivel_clase" readonly>
                        <option value="SD"> SELECCIONA UNA OPCION </option>
                ...
                <div class="col-5 col-md-5 form-group">
                    <div class="alert alert-warning mi_hide" role="alert" id="alertEditHorario" readonly>
