    ...
    <form id='pagos_maestro' enctype="multipart/form-data">
        <div class="container mt-20">
            ...
            $id_maestro    = (isset($_GET['id_maestro'])) ? $_GET['id_maestro'] : '0';
                ?>
            <label>Ver pagos maestros</label>
        ...
        <div class="container" id="container_PagosM"style="display: none">
            <div class="form-row mt-5">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" class="form-control form-control-sm " id="fecha_iniciom" name="fecha_iniciom" readonly>
                            <span class="span_error" id="fecha_iniciom_error"></span>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="fecha_finm" class="label-form">Periodo de fin:</label>
                            <input type="text" class="form-control form-control-sm " id="fecha_finm" name="fecha_finm" readonly>
                            <span class="span_error" id="fecha_finm_error"></span>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="fecha_pagom" class="label-form">Fecha de pago:</label>
                            <input type="text" class="form-control form-control-sm " id="fecha_pagom" name="fecha_pagom" readonly>
                            <span class="span_error" id="fecha_pagom_error"></span>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="monto_pagom" class="label-form">Monto:</label>
                            <input type="text" class="form-control form-control-sm " id="monto_pagom" name="monto_pagom" readonly >
                            <span class="span_error" id="monto_pagom_error"></span>
                        </div>
                        <div class="form-group col-lg-3">
