...
<div class="container mt-5 mb-3">
    <div class="row">
        <div class="col-auto mr-auto my-auto">
            <h5 class="title-width my-auto">Pagos</h5>
        </div>
        <div class="col-auto my-auto ">
            <a class="btn btn-opacity <?= ($_SESSION['userdata']->Pagos[3])?'':'mi_hide';?>" href="<?= base_url;?>Pagos/nueva" >Nueva remisión</a>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto  d-flex justify-content-center">
            ...
            <div class="dropdown-menu" aria-labelledby="id_filtros">
                ...
                <a class="dropdown-item <?= ($data['filtroActual']==1)?'active':'';?>" href="<?= base_url;?>Pagos/index/?filtro=1">Maestros</a>
                <a class="dropdown-item <?= ($data['filtroActual']==2)?'active':'';?>" href="<?= base_url;?>Pagos/index/?filtro=2">Alumnos</a>
                <a class="dropdown-item <?= ($data['filtroActual']==3)?'active':'';?>" href="<?= base_url;?>Pagos/index/?filtro=3">Pagos maestros pendientes</a>
                <a class="dropdown-item <?= ($data['filtroActual']==4)?'active':'';?>" href="<?= base_url;?>Pagos/index/?filtro=4">Pagos alumnos pendientes</a>
        ...
        <div class="col-6 col-lg-auto mr-lg-auto my-2 my-lg-auto d-flex justify-content-center">
            <div class="row">
                <div id="buttonsExport" class="col-12">
                    ...
                    <a id="id_link_excel" href="<?= base_url ?>Pagos/exportarInfo/?tipo_export=<?= "EXCEL".$cadenaExport.$filtroActual; ?>" class="btn" data-toggle="tooltip" data-placement="bottom" title="Exportar a Excel">
                        <i class="material-icons ssc md-36">description</i>
                        <!--img src="<?= base_url ?>public/media/icons/excelIcon.png" width="40px"--!-->
                    </a>
                    <a id="id_link_pdf" href="<?= base_url ?>Pagos/exportarInfo/?tipo_export=<?= "PDF".$cadenaExport.$filtroActual; ?>" target="_blank" class="btn mi_hide" data-toggle="tooltip" data-placement="bottom" title="Exportar a PDF">
    ...
    <div class="row d-flex justify-content-center mt-3">
        ...
        <?php
            if (isset($_SESSION['userdata']->rango_inicio_rem)) {
                ?>
                    <a class="btn btn-opacity" href="<?= base_url;?>Pagos/removeRangosFechasSesion/?filtroActual=<?= $data['filtroActual'];?>">mostrar todo</a>
                <?php
            }
        ?>
    </div>  
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form id="form_rangos" class="row filter-content mb-3" method="post" action="<?= base_url;?>Pagos/index/?filtro=<?= $data['filtroActual']?>">
                        <div class="col-3">
